    ...
    render(){
        return (
            <main>
                ...
                <div id="gallery">
                    {this.props.content.type === "Dogs" ? this.props.content.content.map((dog, index) => {return <Dog key={index} details={dog}/>}) :
                        this.props.content.content.map((shelter, index) => {return <Shelter key={index} details={shelter}/>})}
                </div>
